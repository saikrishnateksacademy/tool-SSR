              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      programInternalName: e.target.value,
                    })
                  }
        ...
        <Card className="p-6 shadow-card">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <Label htmlFor="emiAvailable" className="cursor-pointer">
                  EMI Available
                </Label>
                <Switch
                  id="emiAvailable"
              ...
              <div className="flex items-center justify-between p-3 border rounded-lg">
                <Label htmlFor="noCostEmi" className="cursor-pointer">
                  No Cost EMI
                </Label>
                <Switch
                  id="noCostEmi"
              ...
              <div className="flex flex-wrap gap-2">
                {DELIVERY_FORMATS.map((format) => (
                  <Button
                    ...
                    type="button"
                    variant={
                      formData.delivery.format.includes(format)
                        ? "default"
                        : "outline"
                    }
                    size="sm"
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid gap-3 md:grid-cols-2">
                    ...
                    <Input
                      ...
                      value={uni.logoUrl}
                      onChange={(e) =>
                        updateUniversity(index, "logoUrl", e.target.value)
                      }
                    />
                    <Input
                      type="number"
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateUniversity(index, "partnershipType", value)
                      }
                    >
                      <SelectTrigger>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid gap-3 md:grid-cols-3">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateSpecialization(index, "productId", e.target.value)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        updateCTA(index, "opensForm", checked)
                      }
                    />
                  </div>
                </div>
